export const resumeData = {
  ...
  experience: [
    ...
    {
      company: "BTM Blockchain Technology HUB",
      role: "Blockchain Developer",
  ...
  skills: {
    languages: ["Golang", "C", "Solidity", "REST", "gRPC", "GraphQL"],
    technologies: ["Postgres", "MySQL", "MongoDB", "Redis", "Memcached", "Kafka", "Docker", "Kubernetes", "Helm", "Nomad", "AWS", "GCP", "GKE", "ECS"],
